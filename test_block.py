...
block = torch.load('starcode_block.pt')
#block2 = torch.load('starcode_block.pt')
#block = BlockTwoLayers(block1, block2)


collat = RandomCollator()
dataset = RandomDataset(dim = dim, random_seq_len = False)
